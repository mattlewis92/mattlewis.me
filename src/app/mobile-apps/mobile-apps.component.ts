...
export class MobileAppsComponent {
  ...
  apps: any[] = [{
    ...
    description: 'The SocialSignIn app allows you to schedule and manage posts for all your social networks as well as view your unified social inbox.',
    links: {
      ios: 'https://itunes.apple.com/gb/app/socialsignin/id564011085',
      android: 'https://play.google.com/store/apps/details?id=uk.co.socialsignin'
    }
  }, {
    name: 'MiResource',
    ...
    links: {
      ...
      android: 'https://play.google.com/store/apps/details?id=com.iwazat.miresource'
    }
  }]
